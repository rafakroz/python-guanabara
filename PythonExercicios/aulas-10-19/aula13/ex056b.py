...
elif idademaisVelho == 1:
    print(f'{nomeMaisVelho} é único homem da lista e tem {idademaisVelho} de idade.')
else:
    print(f'{nomeMaisVelho} é o homem mais velho com {idademaisVelho} de idade.')

if totalMulheres20 == 0:
    print(f'Há {totalMulheres} na lista, no entanto, nenhuma com menos de 20 anos de idade.')
