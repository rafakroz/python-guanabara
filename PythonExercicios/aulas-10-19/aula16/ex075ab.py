...
# Separa com vígula e "e" no final

print('Foram inseridos os números: ', end='')
for n in range(len(lista)):
       if n == len(lista) - 1: #            Último elemento
              print(f'e {lista[n]}', end='') 
       elif n == len(lista) - 2: #          Penúltimo elemento
              print(f'{lista[n]} ', end='') 
       else: #                              Elementos iniciais com vírgula
              print(f'{lista[n]}, ', end='') 
